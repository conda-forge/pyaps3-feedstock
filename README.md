...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyaps3-feedstock/blob/master/LICENSE.txt)

Summary: Python based Atmospheric Phase Screen estimation

Development: https://github.com/yunjunz/PyAPS
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13831&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyaps3-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyaps3` can be installed with:

```
conda install pyaps3
```

It is possible to list all of the versions of `pyaps3` available on your platform with:
